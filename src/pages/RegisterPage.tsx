...
const RegisterPage: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setLoading(true);
    try {
      await axios.post(`${API_BASE}/api/auth/register`, { email, password, role });
      ...
      if (err.code === 'ERR_NETWORK') {
        ...
        setError('Registration endpoint not found. Please check the backend URL.');
      } else {
  ...
  return (
    <Box display="flex" justifyContent="center" alignItems="center" minHeight="80vh">
      <Paper sx={{ p: 4, width: 350 }}>
        {/* Logo Section - Top of Register Box */}
        ...
        <Typography variant="h6" gutterBottom align="center" sx={{ mb: 3, color: '#666' }}>Create Your Account</Typography>
