...
import {
  Box, Button, Card, CardContent, Typography, Paper, TextField, MenuItem, Snackbar, Alert, IconButton, Dialog, DialogTitle, DialogContent, DialogActions, Table, TableHead, TableRow, TableCell, TableBody, CircularProgress, useTheme, alpha, Avatar, Badge, Divider, LinearProgress, Chip
} from '@mui/material';
              ...
              <Box sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
                ...
                <Box>
                  <Typography variant="h4" sx={{ fontWeight: 700, mb: 0.5 }}>
                    Asset Passes Management
                  </Typography>
                  <Typography variant="body1" sx={{ opacity: 0.9 }}>
                    Manage security passes and certificates for all assets
                  </Typography>
                </Box>
              </Box>
            </Box>
              ...
              <Box display="flex" alignItems="center" justifyContent="space-between" mb={3}>
                <Box>
                  <Typography variant="h6" sx={{ color: theme.palette.text.primary, fontWeight: 600, mb: 1 }}>
                    🚗 Passes for: {selectedAsset.description}
                  </Typography>
                  <Typography variant="body2" sx={{ color: theme.palette.text.secondary }}>
                    Asset ID: {selectedAsset.plateNumber || selectedAsset.serialNumber || selectedAsset.fleetNumber || selectedAsset.chassisNumber || 'No ID'}
                  </Typography>
                </Box>
                <Button 
                  variant="contained" 
